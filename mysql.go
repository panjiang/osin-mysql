...
var schemas = []string{`CREATE TABLE IF NOT EXISTS {prefix}client (
	...
	client       varchar(64) BINARY NOT NULL,
	code         varchar(64) BINARY NOT NULL PRIMARY KEY,
	...
	client        varchar(64) BINARY NOT NULL,
	authorize     varchar(64) BINARY NOT NULL,
	previous      varchar(64) BINARY NOT NULL,
	access_token  varchar(64) BINARY NOT NULL PRIMARY KEY,
	refresh_token varchar(64) BINARY NOT NULL,
	expires_in    int(10) NOT NULL,
	scope         varchar(255) NOT NULL,
	redirect_uri  varchar(255) NOT NULL,
	extra 		  varchar(255) NOT NULL,
	...
	token         varchar(64) BINARY NOT NULL PRIMARY KEY,
	access        varchar(64) BINARY NOT NULL
